...
SPECS = [
    {"name": "email_list", "fn": t_email_list, "required": [], "group": "Email", "danger": "medium",
    ...
    {"name": "email_read", "fn": t_email_read, "required": ["id"], "group": "Email", "danger": "medium",
    ...
    {"name": "email_search", "fn": t_email_search, "required": ["query"], "group": "Email", "danger": "medium",
    ...
    {"name": "email_draft", "fn": t_email_draft, "required": ["to", "subject", "body"], "group": "Email", "danger": "low",
     "desc": "Write a reply and save it for review. Sends nothing.",
     "params": {"to": "recipients, comma separated", "subject": "subject line",
                "body": "message text"}},
    {"name": "email_send", "fn": t_email_send, "required": ["to", "subject", "body"], "group": "Email", "danger": "critical",
